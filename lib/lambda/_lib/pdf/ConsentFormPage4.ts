...
export class ConsentFormPage4 extends PdfForm implements IPdfForm {
  ...
  private drawBody = async () => {
    ...
    const definitions = [
      ...
      '<sup>1</sup><u>Ethical Transparency Tool</u>  (or <u>ETT</u>) means a tool that enables each ' +
      ...
      `individual completes an ETT “Registration Form” at <u><a href="${registrationHref}">this link</a></u> ` +
      ...
      '<sup>5</sup><u>Consent Recipient(s)</u> (also called <u>Affiliate(s)</u>) mean the entities ' +
      ...
      `<sup>6</sup>The <u>Disclosure Form</u> is the form at <u><a href="${disclosureFormLink}">this link</a></u>.` +
