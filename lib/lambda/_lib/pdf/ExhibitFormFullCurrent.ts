...
export class ExhibitFormFullCurrent extends PdfForm implements IPdfForm {
  ...
  private drawIntro = async () => {
    ...
    await drawWrappedText({ 
      text: isBlankForm ? 
        `<b>This Current Employer(s) Exhibit Form is incorporated into ${fullname} Consent Form, at:</b>` : 
        `<b>This Current Employer(s) Exhibit Form is incorporated into ${fullname} Consent Form, attached to this Exhibit Form.</b>`, 
