...
export class DisclosureFormPage6 extends PdfForm implements IPdfForm {
  ...
  private drawTable = async () => {
    ...
    const misconduct2 = [{ 
      id:'11a', 
      name:'Insert the number(s) (optional but requested):', 
      tooltip:'Insert the number(s) listed above for applicable policy type(s) of violations that your orginaization doesn’t report or that aren’t covered by your policies.'},
    ] as Misconduct[];
          ...
          },
          {
            height: 70, size: 12, backgroundColor: bluegrey, cells: [
              { width: 255, font:boldfont, text: [
                '10. Optional: Other ethics', 'related-misconduct'
              ]} as CellDef,
