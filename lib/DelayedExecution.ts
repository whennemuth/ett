...
export class DelayedExecutionLambdas extends Construct {
  ...
  private createDatabaseExhibitFormPurgeLambda = () => {
    ...
    this._databaseExhibitFormPurgeLambda = new class extends AbstractFunction { }(this, baseId, {
      ...
      entry: 'lib/lambda/functions/delayed-execution/targets/PurgeExhibitFormFromDatabase.ts',
      // handler: 'handler',
      functionName,
      description,
      cleanup: true,
  ...
  private createDisclosureRequestReminderLambda = () => {
    ...
    this._disclosureRequestReminderLambda = new class extends AbstractFunction { }(this, baseId, {
      ...
      memorySize: 512,
      timeout: Duration.seconds(5),
      entry: 'lib/lambda/functions/delayed-execution/targets/SendDisclosureRequestReminder.ts',
      // handler: 'handler',
  ...
  private createBucketExhibitFormPurgeLambda = () => {
    ...
    this._bucketExhibitFormPurgeLambda = new class extends AbstractFunction { }(this, baseId, {
      ...
      // memorySize: 1024,
      timeout: Duration.seconds(5),
      entry: 'lib/lambda/functions/delayed-execution/targets/PurgeExhibitFormFromBucket.ts',
      // handler: 'handler',
      functionName,
      description,
      cleanup: true,
  ...
  private createConsenterPurgeLambda = () => {
    ...
    this._consenterPurgeLambda = new class extends AbstractFunction { }(this, baseId, {
      ...
      // memorySize: 1024,
      timeout: Duration.seconds(15),
      entry: 'lib/lambda/functions/delayed-execution/targets/PurgeConsenter.ts',
      // handler: 'handler',
      functionName,
      description,
      cleanup: true,
  ...
  private createStaleInvitationsLambda = () => {
    ...
    this._removeStaleInvitationsLambda = new class extends AbstractFunction { }(this, baseId, {
      ...
      // memorySize: 1024,
      timeout: Duration.seconds(15),
      entry: 'lib/lambda/functions/delayed-execution/targets/RemoveStaleInvitations.ts',
      // handler: 'handler',
      functionName,
      description,
      cleanup: true,
